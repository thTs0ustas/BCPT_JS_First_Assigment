...
const courseHTML = ` <div class="form-container">
        <form id="courseForm">
              ...
              <tr>
                ...
                <td colspan="2">
                  ...
                  <option value="" disabled selected name="stream">-</option>
                    <option value="${subjects.javascript}" name="stream">${subjects.javascript}</option>
                    <option value="${subjects.java}" name="stream">${subjects.java}</option>
                    <option value="${subjects["C#"]}" name="stream">${subjects["C#"]}</option>
                    <option value="${subjects.python}" name="stream">${subjects.python}</option>
                  </select>
                </td>
              </tr>
              <tr>
